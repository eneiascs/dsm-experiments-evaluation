...
(assert (and (= var_0xINPUT_302 (concat T0_2 T1_2)) (= (len T0_2) 0) (= T1_2 (concat T2_2 T3_2)) (= T2_2 (concat T4_2 T5_2)) (= T5_2 "?") (not (in T4_2 /\?/)) (= var_0xINPUT_302 (concat T0_4 T1_4)) (= (len T0_4) 0) (= T1_4 (concat T2_4 T3_4)) (= T2_4 (concat T4_4 T5_4)) (= T5_4 "#") (not (in T4_4 /#/))))
